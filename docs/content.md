...
- **Live documents** — shared markdown scratchpads with live preview,
  ...
  **download as Markdown or PDF**. Embed **images** (one tap uploads and
  inserts them — room uploads render right in the preview) and
  **```mermaid diagrams**, rendered to SVG on the fly. On phones the
  editor is full-screen with the preview one swipe away.
